        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="sinse-box">
                        <h3 class="sinse-title mb-3">Upicon Group
                        <p class="mt-1">We Build a Better Tomorrow</p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-lg-5 ">
                            <div class="title-box-d">
                                <h4 class="title-d text-green">Dato’ Louis Chai Ming Foo 
            ...
            <div class="row text-center padding">
                <div class="col-lg">
                    ...
                    <div class="text-justify">
                        <div class="title-box-d mt-4">
                            <h4 class="title-d text-green">Datin Seow An Nee 
                                <p class="text-dark">Executive Director, Malaysian</p> </h4>
                        </div>
                        <p class="color-text-a">
                ...
                <div class="col-lg">
                    ...
                    <div class="text-justify">
                        <div class="title-box-d mt-4">
                            <h4 class="title-d text-green">Mr. Ong Poh Huat
                                <p class="text-dark">Executive Director, Malaysian</p> </h4>
                        </div>
                        <p class="color-text-a">
                            Mr. Ong Poh Huat has been involved in property development and building construction for the past 30 years. Mr. Ong is one of the most pioneer member of UPICON Group and a very close partner and friend to Dato’ Louis Chai. His loyalty to UPICON Group has been proved by his active participation since establishment of UPICON Group.
                        </p>
                        <p class="color-text-a">
                            He also plays an advisory role and provides great advice to his subordinates. He has completed multiple projects at the Majlis Daerah Kuala Langat and also participated in Bandar Sungai Emas Banting development scheme.
                        </p>
                    </div>
            ...
            <div class="row mb-0">
                <div class="col-md">
                    <div class="title-box-d my-0">
                        <h4 class="title-d text-green">Company Profile</h4>
                    </div>  
                </div>
            ...
            <div class="row text-justify">
                <div class="col-lg">
                    ...
                    <div class="title-box-d mb-0 mt-4">
                        <h4 class="title-d text-green">Vision</h4>
                    </div>  
                    <p class="color-text-a">
                        Our core vision is to provide a home/infrastructure which improves the  quality of life.
                    </p>

                    <div class="title-box-d mb-0 mt-4">
                        <h4 class="title-d text-green">Mission</h4>
                    </div>  
                    <p class="color-text-a">
                        Our mission is to be a reliable & responsible property developer that delivers outstanding support & services, quality, safe, affordable & value added products for our customers.
                    </p>

                    <div class="title-box-d mb-0 mt-4">
                        <h4 class="title-d text-green">Quality Policy</h4>
                    </div>  
                    <p class="color-text-a">
            ...
            <div class="row text-center">
                <div class="col-md">
                    <img class="img-fluid" src="img/Award2.jpg" alt="">
                </div>
                <div class="col-md">
                    
                    <img class="img-fluid" src="img/Upicon-Values.jpg">
                </div>
            </div>
        </div>
    </section>
